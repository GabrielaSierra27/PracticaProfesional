...
<body>
    ...
    <main>
        ...
        <div class="Container_Create_Browser">
            <button class="btn_Container_Create" onclick="window.location.href='./CreateSpreadsheets.php';">Crear <br> Planilla</button>
            <button class="btn_Container_Browser" onclick="window.location.href='./BrowserSpreadsheets.php';">Consultar <br> Planilla</button>
        </div>
    </main>
