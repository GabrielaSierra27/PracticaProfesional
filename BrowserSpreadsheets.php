    ...
    <div class="wrapper">
        <main>
            ...
            <div class="consulta-modulo">
                <div class="seleccion-busqueda">
                    <label><input type="radio" name="busquedaTipo" value="nit" id="radioNit"> Buscar por NIT</label>
                    <label><input type="radio" name="busquedaTipo" value="ticket" id="radioTicket"> Buscar por Ticket</label>
                </div>

                <div class="buscador">
                    <input type="text" id="nitInput" placeholder="Ingrese NIT..." class="input-busqueda" style="display: none;">
                    <input type="text" id="ticketInput" placeholder="Ingrese Ticket..." class="input-busqueda" style="display: none;">
                ...
                <table class="tabla-resultados">
                    <thead>
                        <tr>
                            <th>Número de Ticked</th>
                            <th>Fecha</th>
                            <th>Contacto</th>
                            <th>Técnico</th>
                            <th>Observaciones</th>
                            <th>Equipo queda Funcionando</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
