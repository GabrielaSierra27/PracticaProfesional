...
<body>
    ...
    <main>
        ...
        <div class="Container_Create_Browser">
            <button class="btn_Container_Create" onclick="window.location.href='./CreateCustomers.php';">Crear <br> Cliente</button>
            <button class="btn_Container_Browser" onclick="window.location.href='./BrowserCustomers.php';">Consultar <br> Cliente</button>
        </div>
    </main>
